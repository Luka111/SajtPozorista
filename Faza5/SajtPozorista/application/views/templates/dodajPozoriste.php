    ...
    <div class="section">
        ...
        <div class="row">
            ...
            <div class="form-group">
                ...
                <input type="text" id="naziv" name="naziv" value="<?php echo set_value('naziv'); ?>" class="form-control">
            </div>
            <div class="form-group">
                <label for="adresa">Adresa <font color="red"> * </font></label>
                <input type="text" id="adresa" name="adresa" value="<?php echo set_value('adresa'); ?>" class="form-control">
            </div>
            <div class="form-group">
                <label for="telefon">Telefon <font color="red"> * </font></label>
                <input type="text" id="telefon" name="telefon" value="<?php echo set_value('telefon'); ?>" class="form-control">
            </div>
            <div class="form-group">
