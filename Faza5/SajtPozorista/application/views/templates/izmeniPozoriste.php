    ...
    <div class="section">
        ...
        <div class="row">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="naziv" id="naziv" value="<?php echo $pozoriste['Naziv']; ?>">
            </div>
             <div class="form-group">
                <label for="adresa">Adresa <font color="red"> * </font></label>
                <input type="text" id="adresa" name="adresa" value="<?php echo $pozoriste['Adresa']; ?>" class="form-control">
            </div>
            <div class="form-group">
                <label for="telefon">Telefon <font color="red"> * </font></label>
                <input type="text" id="telefon" name="telefon" value="<?php echo $pozoriste['Telefon']; ?>" class="form-control">
            </div>
            <div class="form-group">
                <label for="email">Email <font color="red"> * </font></label>
                <input type="email" id="email" name="email" value="<?php echo $pozoriste['Email']; ?>" class="form-control">
            </div>
            <div class="form-group">
